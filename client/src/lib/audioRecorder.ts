 ...
 * Complies with hospital kiosk privacy by releasing microphone hardware tracks immediately on stop.
 */
...
class AudioRecorder {
  ...
  public async start(): Promise<void> {
    ...
    // Buffer size 4096 gives good responsiveness without UI thread stutter
  ...
  public async stop(): Promise<RecordedAudioResult> {
    ...
    // Cleanly release all audio nodes and hardware microphone tracks
    if (this.processor) {
