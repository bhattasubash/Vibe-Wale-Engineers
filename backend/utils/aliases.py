...
# Standard medical laboratory aliases and abbreviations
MEDICAL_TEST_ALIASES: Dict[str, List[str]] = {
    "hemoglobin": ["hb", "hgb", "haemoglobin", "hemoglobin", "hgb."],
    "white blood cell": ["wbc", "white blood cells", "leukocytes", "tlc", "total leukocyte count", "white blood cell count", "wbc count"],
    ...
    "neutrophils": ["neutrophils", "neutrophil", "polys", "segmented neutrophils", "neut"],
    "lymphocytes": ["lymphocytes", "lymphocyte", "lymphs", "lymph"],
    ...
    "direct bilirubin": ["direct bilirubin", "conjugated bilirubin", "d. bilirubin"],
    ...
    "total protein": ["total protein", "protein total", "s. total protein"],
...
def normalize_numeric_string(val: Optional[str]) -> Optional[str]:
    ...
    - Ratios / Blood pressure (120/80 -> 120/80)
    - Decimals (13.20 -> 13.2)
    """
    if not val:
        return None
